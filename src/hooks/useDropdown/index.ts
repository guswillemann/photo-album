...
export default function useDropdown<T extends HTMLElement>(defaultState: boolean): [boolean, () => void, RefObject<T>] {
  ...
  const [containerRef] = useOutsideClick<T>(outsideClickCallback);
